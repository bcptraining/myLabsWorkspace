...
CREATE or alter  WAREHOUSE coco_wh
  ...
  AUTO_RESUME = TRUE
  AUTO_SUSPEND = 120;
alter warehouse coco_wh resume;
use warehouse coco_wh;
select current_user(), 10 * 9;
show warehouses;
SHOW CORTEX SEARCH SERVICES;  -- if listing Cortex Search services
    ...
    "Statement": [
        {
            ...
            "Condition": {
                "StringEquals": {
                    "sts:ExternalId": "UNB14794_SFCRole=3_UMVBvRyXkdWxPSTsRyVRS5Z1Tt0="
                }
            }
        }
    ]
...
CREATE or alter STORAGE INTEGRATION AWS_S3_INT
TYPE = EXTERNAL_STAGE
STORAGE_PROVIDER = S3
ENABLED = TRUE
